...
class apply_import_form extends moodleform {
    public function definition() {
        ...
        $strdeleteolditmes = get_string('delete_old_items', 'apply').
                             ' ('.get_string('oldvalueswillbedeleted', 'apply').')';

        $strnodeleteolditmes = get_string('append_new_items', 'apply').
                               ' ('.get_string('oldvaluespreserved', 'apply').')';
