...
$string['outside_style_help'] = '項目を囲む枠のスタイル．この設定はテーブル内では無視される．また編集中も適用されない．デフォルトは ( '.$string['outside_style_default'].' )';
$string['item_style'] = '項目のスタイル';
$string['item_style_default'] = '';
$string['item_style_help'] = '項目のスタイル．この設定は編集中のデータには適用されない．デフォルトは ( '.$string['item_style_default'].' )';
