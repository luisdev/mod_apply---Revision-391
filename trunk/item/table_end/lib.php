...
class apply_item_table_end extends apply_item_base {
    ...
    public function build_editform($item, $apply, $cm) {
        global $DB, $CFG;
        require_once('table_end_form.php');
        ...
        $this->item_form = new apply_table_end_form('edit_item.php', $customdata);
    }
    ...
    public function print_item_preview($item) {
        ...
        echo '<span class="apply_item_table_end">';
